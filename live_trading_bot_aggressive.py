...
- Lower confidence threshold (0.50 vs 0.70)
...
class AggressiveLiveTradingBot:
    ...
    def __init__(self, config_path='competition.yaml', dry_run=False):
        ...
        self.min_confidence = 0.50  # LOWERED from 0.70
    ...
    def execute_forced_trade(self):
        ...
        for pair in self.trading_pairs:
            ...
            try:
                ...
                confidence = min(0.5 + abs(momentum) * 100, 0.9)
...
def main():
    ...
    print(f"  Min Confidence: 0.50 (AGGRESSIVE)")
    print(f"  Leverage: 4×")
